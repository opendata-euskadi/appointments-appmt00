...
/////////////////////////////////////////////////////////////////////////////////////////
	...
	public void executeOp(final HttpServletRequest request,final HttpServletResponse response,
		...
		case VALIDATE_MAX_WEEK_PERSON_APPOINTMENTS:
			...
			// http://apps.localhost:81/aa14aUIWar/AA14ControllerServlet?op=VALIDATE_MAX_WEEK_PERSON_APPOINTMENTS&personId=30639781D&year=2020&weekOfYear=18&locId=JUSTIZIA_REGISTRO_REPARTO_AM&max=5
