...
@Slf4j
@Singleton
public class AA14CalendarPrintServlet 
     extends HttpServlet {
...
//  
/////////////////////////////////////////////////////////////////////////////////////////
    public AA14CalendarPrintServlet() {
        super();
    } 
    @Inject
    public AA14CalendarPrintServlet(final AA14ClientAPI api) {
    	_clientAPI = api;
    }
/////////////////////////////////////////////////////////////////////////////////////////
//  
...
/////////////////////////////////////////////////////////////////////////////////////////
    ...
    private static void _printAppointment(final AA14OrgDivisionServiceLocation loc,
		...
		// duration
		if (!loc.getOrgDivisionRef().getId().equals(AA14BusinessConfigForJustizia.JUSTIZIA_ID)) {
			w.print("<td class='aa14_time'>");
		...
		// Profile (Justizia)
		if (loc.getOrgDivisionRef().getId().equals(AA14BusinessConfigForJustizia.JUSTIZIA_ID) && app.getBusinessDataAs(AA14BusinessDataForJustizia.class)!=null) {
			w.print("<td>");
			AA14Profile profile = app.getBusinessDataAs(AA14BusinessDataForJustizia.class).getProfile();
			switch (profile.getCode()) {
			case 1: w.println(lang == Language.SPANISH ? "Abogado/a" : "Agokatu");
					break;
			case 2: w.println(lang == Language.SPANISH ? "Procurador(a)" : "Prokuradore");
					break;
			case 3: w.println(lang == Language.SPANISH ? "Ciudadan&iacute;a" : "Hiritartasuna");
					break;
			case 4: w.println(lang == Language.SPANISH ? "Graduado/a Social" : "Gizarte lizentziatua" );
					break;
			case 5: w.println(lang == Language.SPANISH ? "Otros" : "Beste batzuk");
					break;
			default: w.println("");
			}
			w.print("</td>");
